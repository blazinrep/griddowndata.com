...
<body>
<main class="wrap">
  <a href="{base}/" class="brand-logo" aria-label="GridDownData home">
    <img src="/assets/images/grid-down-logo.png" alt="Grid Down Logo" style="height: 50px; width: auto; object-fit: contain; display: block; margin-bottom: 28px;">
  </a>
  <h1>{h1}</h1>

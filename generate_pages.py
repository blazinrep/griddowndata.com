...
<header style="display: flex; align-items: center; justify-content: space-between; padding: 15px 4%; background-color: #0F1214; border-bottom: 1px solid #1E232A; width: 100%; box-sizing: border-box;" role="banner">
  <!-- Brand Block -->
  <div class="brand-header" style="display: flex; align-items: center; gap: 16px; min-width: 300px;">
    ...
    <div class="brand-text" style="display: flex; flex-direction: column;">
      <h1 style="font-family: 'Helvetica Neue', Arial, sans-serif; font-weight: 900; font-size: 24px; color: #FFFFFF; margin: 0; line-height: 1.0; letter-spacing: 1.5px; text-transform: uppercase; border: none; padding: 0; white-space: nowrap;">GRID DOWN</h1>
      <span style="font-family: monospace; font-size: 10px; color: #E65100; letter-spacing: 2.5px; font-weight: bold; text-transform: uppercase; margin-top: 4px; white-space: nowrap;">DATA BLUEPRINT</span>
    </div>
  </div>
